...
public class registrationActivity2 extends AppCompatActivity {
    ...
    public void signup(View view) {
        ...
        if (TextUtils.isEmpty(userName)){
            ...
            Toast.makeText(this, "Entrez votre nom complet", Toast.LENGTH_SHORT).show();
            return;
                 ...
                 .addOnCompleteListener(registrationActivity2.this, new OnCompleteListener<AuthResult>() {
                     ...
                     public void onComplete(@NonNull Task<AuthResult> task) {
                         ...
                         if (task.isSuccessful()){
                             ...
                             Toast.makeText(registrationActivity2.this, "Enregistré avec succès", Toast.LENGTH_SHORT).show();
                              startActivity(new Intent(registrationActivity2.this,MainActivity.class));
                         }else {

                             Toast.makeText(registrationActivity2.this, "Échec de l'enregistrement"+task.getException(), Toast.LENGTH_SHORT).show();
